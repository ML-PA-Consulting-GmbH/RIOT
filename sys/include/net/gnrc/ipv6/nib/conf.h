...
/**
 * @brief    (de-)activate router advertising when router advertisement
 *           is received
 */
#ifndef CONFIG_GNRC_IPV6_NIB_RTR_ADV_ON_RA
#if CONFIG_GNRC_IPV6_NIB_6LR && !CONFIG_GNRC_IPV6_NIB_6LBR
#define CONFIG_GNRC_IPV6_NIB_RTR_ADV_ON_RA            1
#else
#define CONFIG_GNRC_IPV6_NIB_RTR_ADV_ON_RA            0
#endif
#endif

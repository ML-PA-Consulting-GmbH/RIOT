                                  ...
                                  uint8_t *rbuf, unsigned rlen, unsigned payload_len)
{
    ...
    case COAP_TRANSPORT_UDP:
    case COAP_TRANSPORT_DTLS:
        len = coap_build_udp_hdr(rbuf, rlen, type, coap_get_token(pkt), tkl, code, coap_get_id(pkt));
        break;
    case COAP_TRANSPORT_TCP:
        len = coap_build_tcp_hdr(rbuf, rlen, coap_get_token(pkt), tkl, code);
        break;
    case COAP_TRANSPORT_WS:
        len = coap_build_ws_hdr(rbuf, rlen, coap_get_token(pkt), tkl, code);
        break;
    }
